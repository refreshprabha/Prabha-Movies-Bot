...
⬇️Channel link⬇️ </b>""",
                reply_markup=InlineKeyboardMarkup([
                    [ InlineKeyboardButton(text="⚡ Join My Channel⚡️", url=f"https://t.me/Cinegalaxy")]
              ])
            )
            return
    try:
                    ...
                    [
                        [
                            InlineKeyboardButton
                                (
                                    'Share Us 💕', url="http://telegram.dog/share/url?url=telegram.dog/CineCube"
                                )
                        ]
                    ]
                )
    ...
    buttons = [[
        InlineKeyboardButton('Share Us 💕', url="http://telegram.dog/share/url?url=telegram.dog/CineCube"),
    ]]
